...
[![License](https://img.shields.io/badge/license-MIT-seagreen?style=plastic)](https://github.com/Timthreetwelve/WUView/blob/main/LICENSE.txt)
[![.NET 10](https://img.shields.io/badge/.NET-10.0--Windows-blueviolet?style=plastic)](https://dotnet.microsoft.com/en-us/download) 
...
[![Created by real humans](https://img.shields.io/badge/created_by-humans-blue?style=plastic)](https://github.com/Timthreetwelve)
...
Windows Update Viewer uses the Windows Update Agent API and Windows event logs to display details of installed updates. Event log entries are associated with individual updates by using the "KB" number. If an update does not use a KB number or isn't presented in a consistent format, no event log entries will be displayed.
